(function(win, doc) {
  ...
  Main = (function() {
    ...
    Main.prototype.initialize = function() {
      ...
      this.transformView = new UI.Scene('Transform');
      this.loadingView = new UI.Scene('Loading');
      this.sceneManager = new UI.SceneManager([]);
    ...
    Main.prototype.eventify = function() {
      ...
      this.$btnReselect.on('click', (function(_this) {
        return function(e) {
          ...
          return _this.transformView.$el.addClass('is-hidden');
        };
      })(this));
